...
- [x] **Simplify Backup List**: Remove the redundant `Modified Time` column from `gbctl backup list`, as the precise timestamp is already permanently encoded in the archive filename (e.g. `_20260925_124019`).
- [x] **Implement Archive Deep-Dive Command**: Create `gbctl backup info <archive_name>` to provide a detailed, single-archive dashboard.
